...
// Untuk melakukan scroll ke element
WebUI.scrollToElement(findTestObject('Page_DEMOQA/input_Name_firstName'), 0)
...
// Untuk melakukan Click ke Object
WebUI.click(findTestObject('Page_DEMOQA/input_Name_firstName'))

// Melakukan verivikasi bahwa element sudah tersedia
WebUI.verifyElementPresent(findTestObject('Page_DEMOQA/class_Firstname_Invalid'), 8)

...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_DEMOQA/input_Email_userEmail'), 8)

// Melakukan verifikasi bahwa element sudah ada dalam area yang dapat dilihat oleh sistem
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_DEMOQA/input_Email_userEmail'), FailureHandling.STOP_ON_FAILURE)

// Memberikan sedikit jeda selama 2 detik untuk menunggu proses yang sedang berjalan
WebUI.delay(2)

// Melakukan input set Text pada field object dengan menggunakan variable
WebUI.setText(findTestObject('Object Repository/Page_DEMOQA/input_Email_userEmail'), EmailAddress)

// Memberikan sedikit jeda selama 2 detik untuk menunggu proses yang sedang berjalan
WebUI.delay(2)

// Melakukan verivikasi bahwa element sudah tersedia
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_DEMOQA/button_Submit'), 8)
...
// Untuk melakukan scroll ke element
WebUI.scrollToElement(findTestObject('Page_DEMOQA/input_Email_userEmail'), 0)
...
// Melakukan verivikasi bahwa element sudah tersedia
WebUI.verifyElementPresent(findTestObject('Page_DEMOQA/class_Email_Invalid'), 8)

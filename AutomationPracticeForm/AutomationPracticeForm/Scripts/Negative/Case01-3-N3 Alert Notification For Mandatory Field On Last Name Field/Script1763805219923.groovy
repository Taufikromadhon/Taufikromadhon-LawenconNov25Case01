...
// Untuk melakukan scroll ke element
WebUI.scrollToElement(findTestObject('Page_DEMOQA/input_Name_lastName'), 0)
...
// Untuk melakukan Click ke Object
WebUI.click(findTestObject('Page_DEMOQA/input_Name_lastName'))

// Melakukan verivikasi bahwa element sudah tersedia
WebUI.verifyElementPresent(findTestObject('Page_DEMOQA/class_Lastname_Invalid'), 8)

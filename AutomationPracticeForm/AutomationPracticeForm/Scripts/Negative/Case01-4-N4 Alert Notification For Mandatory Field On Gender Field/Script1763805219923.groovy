...
WebUI.verifyElementPresent(findTestObject('Page_DEMOQA/label_Male'), 0)

// Melakukan verivikasi bahwa element sudah tersedia
WebUI.verifyElementVisible(findTestObject('Page_DEMOQA/label_Male'), FailureHandling.STOP_ON_FAILURE)
...
// Untuk melakukan scroll ke element
WebUI.scrollToElement(findTestObject('Page_DEMOQA/label_Male'), 0)
...
// Melakukan verivikasi bahwa element sudah tersedia
WebUI.verifyElementPresent(findTestObject('Page_DEMOQA/class_Gender_Invalid'), 8)
